...
//    private val _downloadedCurrentWeather = MutableLiveData<NewCurrentWeatherResponse>()
//    override val downloadedCurrentWeather: LiveData<NewCurrentWeatherResponse>
    private val _downloadedCurrentWeather = MutableLiveData<NewCurrentWeatherResponse>()
    override val downloadedCurrentWeather: LiveData<NewCurrentWeatherResponse>
    ...
    override suspend fun fetchFutureWeather(
        ...
        try {
            val fetchedFutureWeather = demoApiService
