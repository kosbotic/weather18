...
class ForecastRepositoryImpl(
    ...
    override suspend fun getFutureWeatherList(
        ...
        Log.v("FutureItem","-------start Date-------------------->"+startDate.toString())
...
//    private fun persistFetchedCurrentWeather(fetchedWeather: NewCurrentWeatherResponse) {
//        GlobalScope.launch(Dispatchers.IO) {
//            currentWeatherDao.upsert(fetchedWeather.newCurrentWeatherEntry)
//            weatherLocationDao.upsert(fetchedWeather.newLocation)
//        }
//    }
    ...
    private suspend fun fetchCurrentWeather() {
        ...
        Log.v("repository","-++++++++++-Current Weathe ++++++++++++++++++++++++++++++>"+weatherNetworkDataSource.downloadedCurrentWeather.value)
    }
    ...
    private suspend fun fetchFutureWeather() {
        ...
        Log.v("repository","---------futureCount--------->"+weatherNetworkDataSource.downloadedFutureWeather.value)
    }
